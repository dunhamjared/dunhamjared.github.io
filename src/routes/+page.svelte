...
<div class="flex flex-col justify-center items-center h-screen px-10">
    ...
    >
        <div
            ...
            class="flip-box w-full md:w-6/12 flex justify-center relative"
            class:flipped={showDetails}
        >
            <div class="flip-box-inner relative flex justify-center">
                <img
                    src={logo}
                    alt="profile"
                    class="flip-box-front w-sm rounded-full"
                    style="box-shadow: 0 0 0 1px #ffffff36, 0 58px 20px -39px #5c919d33"
                    width="683"
                    height="683"
                />
                <div
                    class="flip-box-back absolute w-full rounded-4xl overflow-hidden"
                >
                    {@html qrcode}
                </div>
            </div>
        ...
        >
            ...
            {#if !showDetails}
                <div>
                    <h2 class="mt-4 mb-2 font-bold border-b border-gray-600">
                        Technology
                    </h2>
                    <div class="text-sm">
                        <p>I love to work with TypeScript, Svelte, & Adonis.</p>
                        <p>I'm also familiar with SQL, Elastic, & Docker.</p>
                    </div>
                    <h2 class="mt-4 mb-2 font-bold border-b border-gray-600">
                        Personal
                    </h2>
                    <div class="text-sm">
                        <p>
                            During my free time, I like to design, make, and
                            restore many different things.
                        </p>
                    </div>
                </div>
            {/if}
            {#if showDetails}
                <div class="text-2xl mt-5">djared.com</div>
            {/if}

            <div class="mt-7 flex gap-3" class:flex-col={showDetails}>
                <a
                    href="https://www.linkedin.com/in/dunhamjared/"
                    title="LinkedIn"
                    class="hover:text-gray-400 flex gap-3 items-center"
                    target="_blank"
                >
                    <svg
                        class="icon"
                    ...
                    >
                    {#if showDetails}
                        linkedin.com/in/dunhamjared
                    {/if}
                </a>
                <a
                    href="https://github.com/dunhamjared"
                    title="GitHub"
                    class="hover:text-gray-400 flex gap-3 items-center"
                    target="_blank"
                >
                    ...
                    >
                    {#if showDetails}
                        github.com/dunhamjared
                    {/if}
                </a>
                <a
                    href="https://bsky.app/profile/dja.red"
                    title="BlueSky"
                    class="hover:text-gray-400 flex gap-3 items-center"
                    target="_blank"
                >
